...
Average4k::Api::Stubs::LuaSprite Average4k::Api::Functions::FCharts::GetAsyncTexture(int id)
{
	...
	std::shared_ptr<AvgEngine::Base::Sprite> sp = std::make_shared<AvgEngine::Base::Sprite>(-100, -100, reinterpret_cast<char*>(img.data), sizeof(img.data), img.width, img.height);
