...
namespace AvgEngine::Base
{
	...
	public:
		 ...
		 */
		static drawCall FormatDrawCall(int zIndex, std::shared_ptr<OpenGL::Texture> texture, OpenGL::Shader* shader, std::vector<Render::Vertex> vertices, Render::Rect original)
		{
			drawCall call;
